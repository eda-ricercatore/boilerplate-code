...
%%%%%%%%\usepackage{/Users/zhiyang/Documents/rapporti/marzipan-notes/others/packages/clrscode3e}
%	Since most LaTeX installations do not include the LaTeX style files that I am using, include them in a subsubdirectory of my LaTeX templates.
...
% Create the glossary
%%%%%%%%%%\usepackage{./others/packages/nomencl}
%%%%%%%%%%\makenomenclature
