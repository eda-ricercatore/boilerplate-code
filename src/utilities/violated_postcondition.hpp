...
#ifndef __VIOLATEDPOSTCONDITION_H
#define __VIOLATEDPOSTCONDITION_H
using namespace std;

// ==================================================================

class violated_postcondition: public exception {
//	private:
//		string ex_msg;
	...
	public:
		...
		violated_postcondition(string error_message);
